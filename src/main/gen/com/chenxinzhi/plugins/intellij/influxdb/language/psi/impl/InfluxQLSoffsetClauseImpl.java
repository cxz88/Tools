...
public class InfluxQLSoffsetClauseImpl extends ASTWrapperPsiElement implements InfluxQLSoffsetClause {

  public InfluxQLSoffsetClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull InfluxQLVisitor visitor) {
    visitor.visitSoffsetClause(this);
  }
