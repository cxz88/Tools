...
public class InfluxQLOffsetClauseImpl extends ASTWrapperPsiElement implements InfluxQLOffsetClause {

  public InfluxQLOffsetClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
