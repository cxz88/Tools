...
public class InfluxQLMeasurementImpl extends ASTWrapperPsiElement implements InfluxQLMeasurement {

  public InfluxQLMeasurementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public @Nullable String getName() {
    return InfluxQLPsiImplUtil.getName(this);
  }
