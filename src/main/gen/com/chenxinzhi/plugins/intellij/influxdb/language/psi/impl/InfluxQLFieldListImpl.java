...
public class InfluxQLFieldListImpl extends ASTWrapperPsiElement implements InfluxQLFieldList {

  public InfluxQLFieldListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<InfluxQLFieldClause> getFieldClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, InfluxQLFieldClause.class);
  }
