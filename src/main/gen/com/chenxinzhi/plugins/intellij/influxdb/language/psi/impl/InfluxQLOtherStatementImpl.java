...
public class InfluxQLOtherStatementImpl extends ASTWrapperPsiElement implements InfluxQLOtherStatement {

  public InfluxQLOtherStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
