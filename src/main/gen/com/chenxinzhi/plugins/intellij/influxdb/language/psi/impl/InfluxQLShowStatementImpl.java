...
public class InfluxQLShowStatementImpl extends ASTWrapperPsiElement implements InfluxQLShowStatement {

  public InfluxQLShowStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public InfluxQLIdentifierMy getIdentifierMy() {
    return findChildByClass(InfluxQLIdentifierMy.class);
  }

  @Override
  @Nullable
  public InfluxQLMeasurement getMeasurement() {
    return findChildByClass(InfluxQLMeasurement.class);
  }
