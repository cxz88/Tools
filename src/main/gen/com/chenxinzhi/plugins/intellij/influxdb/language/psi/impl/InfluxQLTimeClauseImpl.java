...
public class InfluxQLTimeClauseImpl extends ASTWrapperPsiElement implements InfluxQLTimeClause {

  public InfluxQLTimeClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull InfluxQLVisitor visitor) {
    visitor.visitTimeClause(this);
  }
