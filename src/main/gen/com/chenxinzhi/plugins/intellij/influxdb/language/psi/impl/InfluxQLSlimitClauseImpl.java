...
public class InfluxQLSlimitClauseImpl extends ASTWrapperPsiElement implements InfluxQLSlimitClause {

  public InfluxQLSlimitClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull InfluxQLVisitor visitor) {
    visitor.visitSlimitClause(this);
  }
