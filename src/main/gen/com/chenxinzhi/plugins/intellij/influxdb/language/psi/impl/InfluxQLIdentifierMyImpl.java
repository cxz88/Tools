...
public class InfluxQLIdentifierMyImpl extends ASTWrapperPsiElement implements InfluxQLIdentifierMy {

  public InfluxQLIdentifierMyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull InfluxQLVisitor visitor) {
    visitor.visitIdentifierMy(this);
  }
